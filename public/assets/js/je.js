...
$('#modal-account-list').on('shown.bs.modal', function () {
    ...
    var t = $('#tbl_products').DataTable({
        ...
        "pageLength": 5,
        "ajax": {
            url : URL + '/journal_entry/get_accounts_list',
            type : "POST"
        },
         "columns": [
            {
...
$('#cName').change(function(){
    ...
    if($(this).val() != ''){
        ...
        // $.ajax({
        //     url: URL + '/ap_adjustments/get_dr_nos',
        //     type: "POST",
...
$('#modal-inv-details').on('shown.bs.modal', function () {
   ...
   if($('#cName').val() == ''){
        ...
        //  $.ajax({
        //     url: URL + '/ap_adjustments/get_wrr_nos',
        //     type: "POST",
        //     data:{cCode: $('#cCode').val()},
        //     dataType: 'json',
        //     success: function(data){
        ...
        //         $('#m_cWRRNo').find('option').remove().end().append(options);
...
$('#submit_invoice').click(function(){
    ...
    invoice_t.row.add([
        ...
        cTitle,
        cDesc,
        numberWithCommas(parseFloat(nDebit).toFixed(2)),
        numberWithCommas(parseFloat(nCredit).toFixed(2)),
