            ...
            <div class="card">
                ...
                <fieldset class="gray_box">
                    ...
                    <form role="form" class="form-horizontal" method="POST" enctype="multipart/form-data"
                        action="{{ URL::to('billing_statement/submit_add') }}" name="bs_form" id="bs_form">
                                ...
                                <div class="col-md-6">
                                    <fieldset>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input type="text" name="cInvNo" class="form-control"
                                                    title="Billing Number" autocomplete="off" value="" readonly
                                                    required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    <div class="col-md-8">
                                                        <select data-placeholder="Select Customer" name="cName"
                                                            id="cName" class="form-control form-control-select2"
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="text" name="cCode" id="cCode"
                                                            class="form-control" title="Customer Code" autocomplete="on"
                                                            readonly required />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <textarea name="cRemarks" rows="1" cols="1" class="form-control" title="Remarks"
                                                    placeholder="Enter remarks here .. " autocomplete="off" required></textarea>
                                            </div>
                                        </div>
                                    </fieldset>
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-sm-6">
                                                        <input placeholder="Upload an Attachment" type="file"
                                                            name="cAttachment1" id="cAttachment1" style="border-color:darkgrey"
                                                             />
                                                    </div>
                                                    <div class="col-sm-6">
                                                        <input placeholder="Upload an Attachment" type="file"
                                                            name="cAttachment2" id="cAttachment2" style="border-color:darkgrey"
                                                            />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="input-group">
                                                            <input type="text" name="cRefNo" id="cRefNo" placeholder="00-00000-00-0000"
                                                                class="form-control daterange-single" required />
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <select data-placeholder="Select Tax Type" type="text"
                                                                ...
                                                                <option value="Vat-Exempt">Zero-Rated</option>
                                                            </select>
                                                        </div>
                                                        <div class="col-sm-6">
                                ...
                                <div class="d-flex justify-content-end mt-1">
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control text-end" style="font-size: 18px"
                                                id="totalAmount" disabled readonly />
                                        </div>
                                    </div>
                                </div>
